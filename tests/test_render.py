...
EXPECTED = {
    ...
    "home-assistant/custom_components/regie/palette.py",
    "home-assistant/custom_components/regie/palettes.py",
    "home-assistant/custom_components/regie/sensor.py",
    "home-assistant/custom_components/regie/services.yaml",
